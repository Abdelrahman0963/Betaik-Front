                            ...
                            <div className="flex flex-col gap-6 w-full items-start justify-between">
                                <div className="flex flex-col md:flex-row  md:justify-between items-start   w-full gap-2">
                                    <div className="flex flex-col  gap-2">
                                        <h1 className="text-2xl font-semibold  tracking-tight md:text-3xl">Developer Accounts Management</h1>
                                    ...
                                    >
                                        <nav className="flex items-center gap-2"><FaPlus className='text-white text-sm' />
                                            <p className='text-base'>Create Developer Account</p></nav>
                                    </Link>
                                </div>
