...
const name = () => {
  return (
      <div>
          ...
          <textarea className="w-full h-12 border border-[#D0DFFE] rounded-[10px] bg-[#FAFCFF] text-[#3D414D] px-4 py-2 resize-none focus:outline-none" placeholder="Stanford University"></textarea>

          <div className="mt-4 text-[16px] font-medium text-[#191B1F]">Area</div>
          <textarea placeholder="Enter Area" className="resize-none w-full h-20 border border-[#D0DFFE] rounded-[10px] bg-[#FAFCFF] text-[#3D414D] py-3 px-4 placeholder:text-[#9CA3AF]"></textarea>
