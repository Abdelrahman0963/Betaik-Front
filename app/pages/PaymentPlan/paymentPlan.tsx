            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mt-8">
                {cards.map((c, index) =>
                    c.type === "empty" ? (
                        ...
                        <PaymentPlanCard key={index} data={c.data} index={index} showActions={showActions} setShowActions={setShowActions} handleEdit={handleEdit} handleDelete={handleDelete} />
                    ),
                )}
            </div>
